...
func (h *GroupTrailer) Parse(data string) (int, error) {
	...
	// GroupControlTotal
	if h.GroupControlTotal, size, err = util.ReadField(util.GetNextData(line, read)); err != nil {
	...
	// NumberOfAccounts
	if h.NumberOfAccounts, size, err = util.ReadFieldAsInt(util.GetNextData(line, read)); err != nil {
	...
	// NumberOfRecords
	if h.NumberOfRecords, size, err = util.ReadFieldAsInt(util.GetNextData(line, read)); err != nil {
