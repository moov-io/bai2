...
func (h *FileHeader) Parse(data string) (int, error) {
	...
	// Sender
	if h.Sender, size, err = util.ReadField(util.GetField(line, read)); err != nil {
	...
	// FileCreatedDate
	if h.FileCreatedDate, size, err = util.ReadField(util.GetField(line, read)); err != nil {
	...
	// FileCreatedTime
	if h.FileCreatedTime, size, err = util.ReadField(util.GetField(line, read)); err != nil {
	...
	// FileIdNumber
	if h.FileIdNumber, size, err = util.ReadField(util.GetField(line, read)); err != nil {
	...
	if h.PhysicalRecordLength, size, err = util.ReadFieldAsInt(util.GetField(line, read)); err != nil {
	...
	// BlockSize
	if h.BlockSize, size, err = util.ReadFieldAsInt(util.GetField(line, read)); err != nil {
	...
	// VersionNumber
	if h.VersionNumber, size, err = util.ReadFieldAsInt(util.GetField(line, read)); err != nil {
