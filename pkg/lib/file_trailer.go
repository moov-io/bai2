...
func (h *FileTrailer) Parse(data string) (int, error) {
	...
	// GroupControlTotal
	if h.FileControlTotal, size, err = util.ReadField(util.GetNextData(line, read)); err != nil {
	...
	// NumberOfGroups
	if h.NumberOfGroups, size, err = util.ReadFieldAsInt(util.GetNextData(line, read)); err != nil {
