...
If the [`moov/bai2fuzz`](https://hub.docker.com/r/moov/bai2fuzz) Docker image is running in a Kubernetes cluster you can download the crashers from a mounted volume by executing the following commands.

```
# Get current pod name
$ kubectl get pods -n apps | grep bai2fuzz
bai2fuzz-6bbdc574f5-pl2zm        1/1       Running     0          1h
```
...
```
$ kubectl exec -n apps bai2fuzz-6bbdc574f5-pl2zm -- ls -la /go/src/github.com/moov-io/bai2/test/fuzz-reader/crashers/
total 28
...
$ kubectl cp 'apps/bai2fuzz-6bbdc574f5-pl2zm:/go/src/github.com/moov-io/bai2/test/fuzz-reader/crashers/<file>' ./
```
...
```
# In test/fuzz-reader/
$ fuzzit create job --type=fuzzing bai2fuzz fuzzit.sh
